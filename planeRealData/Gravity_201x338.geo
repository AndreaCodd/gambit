...
// gmsh -3 -o Gravity_201x338.msh Gravity_201x338.geo
...
MeshSizeCore=10*DataMeshSizeVertical;

MeshSizeBase=2*MeshSizeCore;
MeshSizePaddingAir=2*MeshSizeAir;
MeshSizePaddingSurface=10*DataMeshSizeVertical;
