...
MCground = config.MCground
MBtop = config.MBtop
MBbase = config.MBbase
MBground = config.MBground
...
"""
open(config.geo_name,'w').write(out)
print("mesh made and written to file "+config.geo_name)
