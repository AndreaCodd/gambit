...
pdetol     = 1.e-10     # make sure this is the square of rtol
iter_max   = 250 
...
namea= 'syntheticrrr_s_'+str(int(s))+'_a_'+str(int(a))+'_b_'+str(int(b))+'_'
...
# read in gravity
gz = np.loadtxt('synthgz.csv',delimiter=',')
